...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{route('users.update', $data['userDetails']['result']['id'])}}" method ="post" enctype="multipart/form-data">
                {{csrf_field()}}
                @method('PUT')
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile" style="padding:.9rem;">
                                <div class="form-group">
                                    ...
                                    <input name="user_photo" value="" id="profile_image" type="file" class="form-control-sm form-control" />
                                ...
                                <ul class="list-group list-group-unbordered">
                                    ...
                                    <li class="list-group-item" style="border:0px;">
                                        ...
                                        <div class="form-group" style="margin-bottom:0rem">
                                            <label for="first_name" style="font-weight: normal;font-size:14px;">{{'First
                                                Name'}}</label>
                                            <input name="first_name" id="first_name" value="{{$data['userDetails']['result']['first_name']}}" type="text" class="form-control-sm form-control">
                                    ...
                                    <li class="list-group-item" style="border:0px;" >
                                        <div class="form-group" style="margin-bottom:0rem">
                                            <label for="last_name" style="font-weight: normal;font-size:14px;">{{'Last
                                                Name'}}</label>
                                            <input name="last_name" id="last_name" value="{{$data['userDetails']['result']['last_name']}}" type="text" class="form-control-sm form-control">
                                    ...
                                    <li class="list-group-item"  style="border:0px;">
                                        <div class="form-group" style="margin-bottom:0rem">
                                            ...
                                            <input name="email" id="email" value="{{$data['userDetails']['result']['email']}}" type="email" class="form-control-sm form-control">
                                    ...
                                    <li class="list-group-item"  style="border:0px;">
                                        <div class="form-group"  style="margin-bottom:0rem">
                                            ...
                                            <input name="experience" id="experience" value="{{$data['userDetails']['result']['experience']}}" min="0" type="number" class="form-control-sm form-control">
                                    ...
                                    <li class="list-group-item"  style="border:0px;">
                                        <div class="form-group"  style="margin-bottom:0rem">
                                            ...
                                            <input name="speciality" id="speciality" value="{{$data['userDetails']['result']['speciality']}}" type="text" class="form-control-sm form-control">
                                                                ...
                                                                <div class="form-group col-md-8">
                                                                    <div class="row">
                                                                        <div class="col-md-9">
                                                                            ...
                                                                            <input name="ssc_org_name" id="ssc_org_name" value="{{$data['userDetails']['educationalQualification']['ssc_org_name'] ?? ""}}" type="text" class="form-control-sm form-control">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6" style="max-width: 45%">
                                                                            ...
                                                                            <input name="ssc_passing_year" id="ssc_passing_year" value="{{$data['userDetails']['educationalQualification']['ssc_passing_year'] ?? ""}}" type="text" class="form-control-sm form-control">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <input name="ssc_gpa" id="ssc_gpa" value="{{$data['userDetails']['educationalQualification']['ssc_gpa'] ?? ""}}" type="text" class="form-control-sm form-control">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="form-group col-md-8">
                                                                    <div class="row">
                                                                        <div class="col-md-9">
                                                                            <label for="org_name" style="font-weight: normal;font-size:14px;">{{'Organization Name'}}</label>
                                                                            <input name="hsc_org_name" id="hsc_org_name" value="{{$data['userDetails']['educationalQualification']['hsc_org_name'] ?? ""}}" type="text" class="form-control-sm form-control">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6" style="max-width: 45%">
                                                                            ...
                                                                            <input name="hsc_passing_year" id="hsc_passing_year" value="{{$data['userDetails']['educationalQualification']['hsc_passing_year'] ?? ""}}" type="text" class="form-control-sm form-control">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <label for="gpa" style="font-weight: normal;font-size:14px;">{{'GPA'}}</label>
                                                                            <input name="hsc_gpa" id="hsc_gpa" value="{{$data['userDetails']['educationalQualification']['hsc_gpa'] ?? ""}}" type="text" class="form-control-sm form-control">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="form-group col-md-8">
                                                                    <div class="row">
                                                                        <div class="col-md-9">
                                                                            <label for="org_name" style="font-weight: normal;font-size:14px;">{{'Organization Name'}}</label>
                                                                            <input name="honors_org_name" id="honors_org_name" value="{{$data['userDetails']['educationalQualification']['honors_org_name'] ?? ""}}" type="text" class="form-control-sm form-control">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6" style="max-width: 45%">
                                                                            <label for="passing_year" style="font-weight: normal;font-size:14px;">{{'Passing Year'}}</label>
                                                                            <input name="honors_passing_year" id="org_name" value="{{$data['userDetails']['educationalQualification']['honors_passing_year']?? ""}}" type="text" class="form-control-sm form-control">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <label for="gpa" style="font-weight: normal;font-size:14px;">{{'GPA'}}</label>
                                                                            <input name="honors_gpa" id="honors_masters_gpa" value="{{$data['userDetails']['educationalQualification']['honors_gpa']?? ""}}" type="text" class="form-control-sm form-control">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="form-group col-md-8">
                                                                    <div class="row">
                                                                        <div class="col-md-9">
                                                                            <label for="org_name" style="font-weight: normal;font-size:14px;">{{'Organization Name'}}</label>
                                                                            <input name="masters_org_name" id="masters_org_name" value="{{$data['userDetails']['educationalQualification']['masters_org_name']?? ""}}" type="text" class="form-control-sm form-control">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6" style="max-width: 45%">
                                                                            <label for="passing_year" style="font-weight: normal;font-size:14px;">{{'Passing Year'}}</label>
                                                                            <input name="masters_passing_year" id="masters_passing_year" value="{{$data['userDetails']['educationalQualification']['masters_passing_year']?? ""}}" type="text" class="form-control-sm form-control">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <label for="gpa" style="font-weight: normal;font-size:14px;">{{'GPA'}}</label>
                                                                            <input name="masters_gpa" id="masters_gpa" value="{{$data['userDetails']['educationalQualification']['masters_gpa']?? ""}}" type="text" class="form-control-sm form-control">
