    ...
    <div class="card-body">
        <div class="tab-content">
            <div class="active tab-pane" id="activity">
                <table id="dashboardRecentPatientTable" aria-describedby="dashboardRecentPatientTable" class="table table-bordered table-striped">
                    <tbody>
                        @foreach($data['recent_admitted_patient'] as $recent)
                        <tr>
                            ...
                            <td>
                                ...
                                <div>{{'Admitted on: '. date('m-d-Y',strtotime($recent->admission_date))}}</div>
