...
<section class="content">
    <div class="container-fluid">
        <div class="row">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="active tab-pane" id="activity">
                                <div class="row mx-auto">
                                    @for($i=0;$i<6;$i++) <div class="info-box mb-3 ml-2 mr-1">
                                        <div class="info-box-content">
                                            <span class="info-box-number stuff_name">Sally Smith</span>
                                            <span class="info-box-number tablet_name">Tablet #30</span>
                                        </div>
                                        <span class="info-box-icon"><button class="btn btn-info btn-xs">View</button></span>
            ...
            @include('admin_level.dashboard.recentAdmitted')
            @include('admin_level.dashboard.recentDischarged')
